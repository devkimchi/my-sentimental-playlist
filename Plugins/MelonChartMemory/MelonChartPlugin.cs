...
// namespace MySentimentalPlaylist.Notebooks.Plugins.MelonChartMemory;

#pragma warning disable SKEXP0001

public class MelonChartPlugin
{
    private const string COLLECTION = "MelonChart";

    [KernelFunction, Description("Add Melon Chart data to the memory")]
    public static async Task AddMelonChart(
        ...
        [Description("The JsonSerializerOptions instance")] JsonSerializerOptions jso)
    {
        ...
        var data = await http.GetStringAsync($"https://raw.githubusercontent.com/aliencube/MelonChart.NET/main/data/top00-{today}.json");
    ...
    public static async Task AddSpotifyChart(
        [Description("The Semantic Memory instance")] ISemanticTextMemory memory,
        [Description("The HttpClient instance")] HttpClient http,
        [Description("The JsonSerializerOptions instance")] JsonSerializerOptions jso)
    {
        ...
        var data = await http.GetStringAsync($"https://raw.githubusercontent.com/aliencube/MelonChart.NET/main/data/spotify00-{today}.json");
        var chart = JsonSerializer.Deserialize<ChartItemCollection>(data, jso);
